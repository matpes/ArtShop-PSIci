...
@section('content')
    <div class="row justify-content-center noPadding">
        ...
        <div class="col-md-4 mb-0 ml-0 text-md-left noPadding">
            ...
            <br>
            {{--     prosečna ocena     --}}
            <div class="col-md-12 text-md-left">Prosečna ocena: &emsp;


                @if($slikar->sumaOcena == 0)
                    {{"Nemate još nijednu ocenu/sliku"}}
                @else
                    {{$slikar->sumaOcena / $slikar->brOcenjenihSlika}}
                @endif
            </div>
            <br>
            {{--     broj ocena     --}}
            <div class="col-md-12 text-md-left">Broj ocena: &emsp;
